...
iotc_data = xr.Dataset(data_vars=dict(ps_effort=(['month', 'lat', 'lon'], ps.effort.data),
                                      ll_effort=(['month', 'lat', 'lon'], ll.effort.data),
                                      lon_bnd=(['lon_bnd'], lon_bnd_ps),
                                      lat_bnd=(['lat_bnd'], lat_bnd_ps)),
                       coords=dict(month=(['month'], mon),
                                   lat=(['lat'], lat_ps),
                                   lon=(['lon'], lon_ps)),
                       attrs=dict(data_source='https://www.iotc.org/'))
...
ps_plot = ax[0].pcolormesh(iotc_data.lon_bnd, iotc_data.lat_bnd, iotc_data.ps_effort.mean(dim='month'),
...
ll_plot = ax[2].pcolormesh(iotc_data.lon_bnd, iotc_data.lat_bnd, iotc_data.ll_effort.loc[7,:,:],
...
iotc_data.to_netcdf(dirs['data_proc'] + 'IOTC_monclim.nc')
